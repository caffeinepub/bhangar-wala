...
import { useAddAddress } from '../hooks/useQueries';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      >
        ...
        <h1 className="font-heading text-xl font-bold text-white">Add Address</h1>
        <p className="text-white/80 text-sm mt-1">Add a new pickup location</p>
      </div>
      ...
      <div className="flex-1 px-4 py-6 space-y-4">
        ...
        {addAddress.isError && (
          <p className="text-destructive text-sm">Failed to save address. Please try again.</p>
        )}
      </div>
